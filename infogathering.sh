...
echo "# Clean up individual tool outputs if needed"
...
echo "#aquatone find all live interesting subdomains for you baby "
...
echo "################################# Find all urls using waybackurls  Start ###########################"
